...
const registerSchema = yup.object().shape({
    ...
    email: yup
        .string()
        .email("Invalid email!")
        .required("This field is required! reg"),
    password: yup.string().required("This field is required! reg"),
...
const Form = () => {
    ...
    const register = async (values, onSubmitProps) => {
        const formData = new FormData(); // use formData for sending image file
